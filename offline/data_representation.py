...
from service.term_frequency import convert_datafarme_to_text

tf_df= pd.DataFrame
tfidf_df= pd.DataFrame
inverted_index_corpus={}
def data_representation(corpus):
    print("=============================================")
    print("==                 Indexing                ==")
    print("=============================================")
    global tf_df
    ...
    store_file.creat_file_from_map(store_file.path_duplicated, duplicated_corpus)

    # inverted index
    inverted_index_corpus = inverted_index.create_inverted_index(duplicated_corpus)
    #print(inverted_index_corpus)
    store_file.creat_file_from_map(store_file.path_inverted_index,inverted_index_corpus)
    ...
    #store_file.creat_file(store_file.path_tf_df, str_tf_df)
    ...
    #store_file.creat_file(store_file.path_tfidf_df, str_tfidf_df)
