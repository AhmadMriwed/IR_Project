...
def online():
    ...
    data_inverted_index=sc.search_cluster_by_s(
        configoration.get_by_languagea(data_representation_en,data_representation_ar),
    ...
    rank_docs=rd.rank(qrp.tfidf_df,
                      ...
                      configoration.get_by_language(tfidf_df_ar,tfidf_df_en),
...
#    docs.read_dataset_ar()
    offline(corpus,configoration.language_code_en)
    #online()
    evaluation()
